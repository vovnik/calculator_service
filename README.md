...
математические константы PI и E, а также тригонометрические функции, подробнее см. в документации к библиотеке. И самое главное: вычисления НЕ реализованы через питоновский eval как в sympy, т.к. библиотека парсит именно математическое выражение. Отсутствие eval есть главное условие безопасности кода.
